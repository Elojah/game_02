...
// source: github.com/elojah/game_02/pkg/player/player.proto

package player

import (
	fmt "fmt"
	entity "github.com/elojah/game_02/pkg/entity"
...
func (*P) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cca7a24dac659cf, []int{0}
}
...
func (m *P) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_P.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *P) XXX_Merge(src proto.Message) {
	xxx_messageInfo_P.Merge(m, src)
}
func (m *P) XXX_Size() int {
	return m.Size()
}
func (m *P) XXX_DiscardUnknown() {
	xxx_messageInfo_P.DiscardUnknown(m)
}

var xxx_messageInfo_P proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*P)(nil), "player.P")
}

func init() {
	proto.RegisterFile("github.com/elojah/game_02/pkg/player/player.proto", fileDescriptor_9cca7a24dac659cf)
}

var fileDescriptor_9cca7a24dac659cf = []byte{
	...
	,
	...
	0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x48, 0x62, 0x03, 0xbb, 0xdf, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0x1e, 0xd7, 0x90, 0x2c, 0x5e, 0x01, 0x00, 0x00,
}
...
func NewPopulatedP(r randyPlayer, easy bool) *P {
	this := &P{}
	v1 := entity.NewPopulatedE(r, easy)
	this.Entity = *v1
...
func (m *P) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: P: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: P: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
