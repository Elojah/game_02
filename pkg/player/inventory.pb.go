...
// source: github.com/elojah/game_02/pkg/player/inventory.proto
...
type Inventory struct {
	...
	Items map[string]uint64                     `protobuf:"bytes,3,rep,name=Items,proto3" json:"Items" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (m *Inventory) Reset()      { *m = Inventory{} }
func (*Inventory) ProtoMessage() {}
func (*Inventory) Descriptor() ([]byte, []int) {
	return fileDescriptor_8a969a04af714f22, []int{0}
}
...
func init() {
	proto.RegisterType((*Inventory)(nil), "player.Inventory")
	proto.RegisterMapType((map[string]uint64)(nil), "player.Inventory.ItemsEntry")
}

func init() {
	proto.RegisterFile("github.com/elojah/game_02/pkg/player/inventory.proto", fileDescriptor_8a969a04af714f22)
}

var fileDescriptor_8a969a04af714f22 = []byte{
	...
	,
	...
	0x31, 0xdc, 0x78, 0x2c, 0xc7, 0x90, 0xc4, 0x06, 0x0e, 0x1d, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x40, 0xe4, 0xd7, 0x41, 0x8c, 0x01, 0x00, 0x00,
}
...
func (m *Inventory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Items) > 0 {
		for k := range m.Items {
			...
			i--
			dAtA[i] = 0xa
			i = encodeVarintInventory(dAtA, i, uint64(baseI-i))
			i--
			dAtA[i] = 0x1a
		}
	}
