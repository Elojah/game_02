...
func (*Vec3) Descriptor() ([]byte, []int) {
	return fileDescriptor_position_3ef4eb046de4b7e0, []int{0}
}
...
type Position struct {
	SectorID             github_com_elojah_game_02_pkg_ulid.ID `protobuf:"bytes,1,opt,name=SectorID,json=sectorID,proto3,customtype=github.com/elojah/game_02/pkg/ulid.ID" json:"SectorID"`
...
func (*Position) Descriptor() ([]byte, []int) {
	return fileDescriptor_position_3ef4eb046de4b7e0, []int{1}
}
...
func init() { proto.RegisterFile("position.proto", fileDescriptor_position_3ef4eb046de4b7e0) }

var fileDescriptor_position_3ef4eb046de4b7e0 = []byte{
	...
	0x31, 0x43, 0x3f, 0x3d, 0x31, 0x37, 0x35, 0xde, 0xc0, 0x48, 0xbf, 0x20, 0x3b, 0x5d, 0xbf, 0x34,
	...
	0xff, 0x61, 0x01, 0x26, 0x3f, 0x41, 0x01, 0x00, 0x00,
}
