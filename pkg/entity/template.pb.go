...
type Template struct {
	...
	// #Stats
	MaxHP uint64 `protobuf:"varint,3,opt,name=MaxHP,json=maxHP,proto3" json:"MaxHP,omitempty"`
	MaxMP uint64 `protobuf:"varint,4,opt,name=MaxMP,json=maxMP,proto3" json:"MaxMP,omitempty"`
	// #Spatial & graphic parameters
	AssetID github_com_elojah_game_02_pkg_ulid.ID `protobuf:"bytes,5,opt,name=AssetID,json=assetID,proto3,customtype=github.com/elojah/game_02/pkg/ulid.ID" json:"AssetID"`
	// #In game external ids
	SpawnID              github_com_elojah_game_02_pkg_ulid.ID `protobuf:"bytes,6,opt,name=SpawnID,json=spawnID,proto3,customtype=github.com/elojah/game_02/pkg/ulid.ID" json:"SpawnID"`
...
func (*Template) Descriptor() ([]byte, []int) {
	return fileDescriptor_template_a817dac897e7203d, []int{0}
}
...
func (m *Template) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintTemplate(dAtA, i, uint64(m.ID.Size()))
	...
	dAtA[i] = 0x2a
	i++
	i = encodeVarintTemplate(dAtA, i, uint64(m.AssetID.Size()))
	n2, err := m.AssetID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
	dAtA[i] = 0x32
	i++
	i = encodeVarintTemplate(dAtA, i, uint64(m.SpawnID.Size()))
	n3, err := m.SpawnID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func init() { proto.RegisterFile("template.proto", fileDescriptor_template_a817dac897e7203d) }

var fileDescriptor_template_a817dac897e7203d = []byte{
	...
	0x5f, 0x90, 0x9d, 0xae, 0x5f, 0x9a, 0x93, 0x99, 0xa2, 0xe7, 0xe9, 0x12, 0xc4, 0x94, 0xe9, 0x22,
	0x24, 0xc4, 0xc5, 0xe2, 0x97, 0x98, 0x9b, 0x2a, 0xc1, 0xa4, 0xc0, 0xa8, 0xc1, 0x19, 0xc4, 0x92,
	0x97, 0x98, 0x9b, 0x2a, 0x24, 0xc2, 0xc5, 0xea, 0x9b, 0x58, 0xe1, 0x11, 0x20, 0xc1, 0xac, 0xc0,
	0xa8, 0xc1, 0x12, 0xc4, 0x9a, 0x0b, 0xe2, 0x40, 0x45, 0x7d, 0x03, 0x24, 0x58, 0xe0, 0xa2, 0xbe,
	0x01, 0x42, 0xee, 0x5c, 0xec, 0x8e, 0xc5, 0xc5, 0xa9, 0x25, 0x9e, 0x2e, 0x12, 0xac, 0xe4, 0xb8,
	0x81, 0x3d, 0x11, 0xa2, 0x1b, 0x64, 0x50, 0x70, 0x41, 0x62, 0x79, 0x9e, 0xa7, 0x8b, 0x04, 0x1b,
	0x59, 0x06, 0x15, 0x43, 0x74, 0x3b, 0x59, 0x5c, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1, 0x1c, 0xc3,
	...
	0x58, 0x8e, 0x21, 0x89, 0x0d, 0x1c, 0xbc, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x72, 0xc1,
	0xb7, 0xe9, 0xa7, 0x01, 0x00, 0x00,
}
