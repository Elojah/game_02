...
export class ReadSet extends jspb.Message {
  hasAuth(): boolean;
  clearAuth(): void;
  getAuth(): github_com_elojah_game_02_pkg_account_dto_account_pb.Auth | undefined;
  setAuth(value?: github_com_elojah_game_02_pkg_account_dto_account_pb.Auth): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ReadSet.AsObject;
  static toObject(includeInstance: boolean, msg: ReadSet): ReadSet.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ReadSet, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ReadSet;
  static deserializeBinaryFromReader(message: ReadSet, reader: jspb.BinaryReader): ReadSet;
}

export namespace ReadSet {
  export type AsObject = {
    auth?: github_com_elojah_game_02_pkg_account_dto_account_pb.Auth.AsObject,
    id: Uint8Array | string,
  }
