...
// Namespaces maps configs used for web server.
type Namespaces struct {
	Web services.Namespace
}

// Launcher represents a web server launcher.
...
// NewLauncher returns a new web server Launcher.
...
// Up starts the web server service with new configs.
...
// Down stops the web server service.
